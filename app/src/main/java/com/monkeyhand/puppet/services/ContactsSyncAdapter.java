...
import com.monkeyhand.puppet.Cache;
import com.monkeyhand.puppet.TindroidApp;
import com.monkeyhand.puppet.account.ContactsManager;
import com.monkeyhand.puppet.account.Utils;
import com.monkeyhand.puppet.media.VxCard;
import com.monkeyhand.puppet.PromisedReply;
import com.monkeyhand.puppet.Tinode;
import com.monkeyhand.puppet.Topic;
import com.monkeyhand.puppet.model.MetaGetSub;
...
class ContactsSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String ACCKEY_SYNC_MARKER = "com.monkeyhand.puppet.sync_marker_contacts";
    private static final String ACCKEY_QUERY_HASH = "com.monkeyhand.puppet.sync_query_hash_contacts";
