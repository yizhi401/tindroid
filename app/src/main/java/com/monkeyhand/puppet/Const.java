...
public class Const {
    ...
    public static final String INTENT_ACTION_CALL_CLOSE = "puppet.intent.action.call.CLOSE";

    public static final String INTENT_EXTRA_TOPIC = "com.monkeyhand.puppet.TOPIC";
    public static final String INTENT_EXTRA_SEQ = "com.monkeyhand.puppet.SEQ";
    public static final String INTENT_EXTRA_SENDER_NAME = "com.monkeyhand.puppet.SENDER_NAME";
    public static final String INTENT_EXTRA_CALL_DIRECTION = "com.monkeyhand.puppet.CALL_DIRECTION";
    public static final String INTENT_EXTRA_CALL_ACCEPTED = "com.monkeyhand.puppet.CALL_ACCEPTED";
    public static final String INTENT_EXTRA_CALL_AUDIO_ONLY = "com.monkeyhand.puppet.CALL_AUDIO_ONLY";
